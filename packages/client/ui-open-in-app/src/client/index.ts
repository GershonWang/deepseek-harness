 ...
 *
 * The Session-header directory control reads availability once per page and
 * asks the host to re-read it as the menu opens, because the host's installed
 * applications change while the page lives.
 */
