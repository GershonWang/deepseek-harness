...
var messages = map[Locale]map[string]string{
	Zh: {
		...
		"toolchain.error.archiveTooLarge": "安装包体积超出上限，已中止安装",
		"toolchain.error.checksum":        "文件校验失败，可能下载不完整或被篡改",
		"toolchain.error.extract":         "文件解压失败，归档可能已损坏",
		"toolchain.error.extractTooLarge": "解压后的数据超出上限，已中止安装",
		"toolchain.error.network":         "网络连接失败，请检查网络后重试",
		"toolchain.error.noSpace":         "磁盘空间不足，请清理后重试",
		"toolchain.error.permission":      "写入权限不足，请检查安装目录权限",
		"toolchain.error.timeout":         "下载超时，请检查网络后重试",
		"toolchain.error.unknown":         "安装失败",
	...
	En: {
		...
		"toolchain.error.archiveTooLarge": "The archive exceeds the size limit; installation stopped",
		"toolchain.error.checksum":        "Checksum verification failed; the download may be incomplete or tampered with",
		"toolchain.error.extract":         "Failed to extract the archive; it may be corrupt",
		"toolchain.error.extractTooLarge": "Extracted data exceeds the size limit; installation stopped",
		"toolchain.error.network":         "Network connection failed; check your network and retry",
		"toolchain.error.noSpace":         "Not enough disk space; free some space and retry",
		"toolchain.error.permission":      "Permission denied; check the install directory permissions",
		"toolchain.error.timeout":         "Download timed out; check your network and retry",
		"toolchain.error.unknown":         "Installation failed",
