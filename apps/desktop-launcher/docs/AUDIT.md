...
- **本节是 2026-09-20 的时点快照，此后不随状态更新。** 其后第 14 行（24 壳前端 i18n）于 2026-09-22、第 22 行（N28）于 2026-09-25 转为「已修」：H.1 中这两行的「复核结论」保留当时取值，现行状态以「条目总览」索引表与各条目正文为准。
