...
export const TRANSLATION_SCOPE_GLOB_EXCLUDES = [
  ...
  'apps/web/dist/**',
  '.artifacts/**',
  'apps/desktop-launcher/linglong/linglong/**',
  'apps/desktop-launcher/linglong/stage/**',
  'linglong/**',
 ...
 * The desktop launcher's Linglong build trees qualify: they hold extracted base
 * images, staged payloads, and built packages, all gitignored and rewritten by
 * every build.
 */
